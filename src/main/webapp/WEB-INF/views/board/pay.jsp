...
<!-- 		<input type="submit" value="확인"> -->
		...
		<div id="my-dialog">
			<label>메인 또는 마이페이지 클릭시 결제 완료 ;)</label>
			<br>
			<button id="btn-close-dialog-main">메인 페이지</button>
			<button id="btn-close-dialog-mypage">마이 페이지</button>
			<br><br>
