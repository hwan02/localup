...
<body>
			...
			<div class="option">
				<div>
					<form onsubmit="searchPlaces(); return false;">
						<input type="text" id="keyword" size="15" placeholder="주소검색">
	...
	<script type="text/javascript"
		src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f91e6d892e5876c99502e2d0571baffb&libraries=services"></script>
	<script>
		// 마커를 담을 배열입니다
		var markers = [];
		...
		daum.maps.event.addListener(map, 'click', function(mouseEvent) {
			...
			//var infowindow=null; ===> NULL 아닐때 close
// 			if(infowindow!=null){
// 				infowindow.close();
// 			}
...
// 				marker.setVisible(false); //마커 숨긴다			
