...
<!--메뉴 클릭시 사이드바 생성-->
<script type="text/javascript" src="/resources/my_js/myApplyPast.js"></script>
...
<!--메뉴 클릭시 사이드바 생성-->
<link rel="stylesheet" href="/resources/my_css/myApplyPast.css">
		...
		<tbody id="myTable">
			<c:forEach items="${GuideVO}" var="GuideVO"  varStatus="stat">
				...
				<td>${GuideVO.tour_edate }</td>
					...
					<!--가이드 상세페이지 이동하기-->
					<td><a
						href='/guide/guideDetailPage?board_no=${GuideVO.board_no}'>
